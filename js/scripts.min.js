...
$(function() {
	...
	$(window).on('load', function() {
		...
		if ($('#img').css('width') == '760px') {
			$('#img').delay(1600).animate({marginTop: "126px", opacity: 1}, 800, "easieEaseOutQuart");
			$('.header-composition').delay(1600).animate({marginTop: "205px", opacity: 1}, 800, "easieEaseOutQuart");
		} else if ($('#img').css('width') == '660px') {
			$('#img').delay(1600).animate({marginTop: "160px", opacity: 1}, 800, "easieEaseOutQuart");
			$('.header-composition').delay(1600).animate({marginTop: "205px", opacity: 1}, 800, "easieEaseOutQuart");
		} else if ($('#img').css('width') == '560px') {
			$('#img').delay(1600).animate({marginTop: "150px", opacity: 1}, 800, "easieEaseOutQuart");
			$('.header-composition').delay(1600).animate({marginTop: "180px", opacity: 1}, 800, "easieEaseOutQuart");
		} else if ($('#img').css('width') == '460px') {
			$('#img').delay(1600).animate({marginTop: "145px", opacity: 1}, 800, "easieEaseOutQuart");
			$('.header-composition').delay(1600).animate({marginTop: "150px", opacity: 1}, 800, "easieEaseOutQuart");
		}
	});

	$('.img-container').height($('.img-container').width()/1.84);
	$(window).resize(function(){
		$('.img-container').height($('.img-container').width()/1.84);
	});
	$('.img-photo-container').height($('.img-photo-container').width()/1.527);
	$(window).resize(function(){
		$('.img-photo-container').height($('.img-photo-container').width()/1.527);
	});
	...
	$('.callback').on('click', function () {
		$('.callback-container').addClass('active');
		$('.callback-header-form').animate({top: "21vh", opacity: 1}, 400);
	});
	$('.callback-before').on('click', function () {
		$('.callback-header-form').animate({top: "0vh", opacity: 0}, 300);
		setTimeout(function() {
			$('.callback-container').removeClass('active');
		}, 200);
	});
	...
	$('.personal').on('click', function () {
		...
		$('.personal-form').animate({top: "10vh", opacity: 1}, 400);
	});
	$('.personal-before').on('click', function () {
		$('.personal-form').animate({top: "0vh", opacity: 0}, 300);
		setTimeout(function() {
			$('.personal-container').removeClass('active');
		}, 200);
	});
	...
	$('.services-item').on('click', function () {
		$('.services-callback-container').addClass('active');
		$('.services-callback-form').animate({top: "13vh", opacity: 1}, 400);
	});
	$('.services-callback-before').on('click', function () {
		$('.services-callback-form').animate({top: "0vh", opacity: 0}, 300);
		setTimeout(function() {
			$('.services-callback-container').removeClass('active');
		}, 200);
	});
	$('.close').on('click', function () {
		$('.services-callback-form').animate({top: "0vh", opacity: 0}, 300);
	...
	$('.img-photo-container').on('click', function () {
		var photoSrc = "img/" + $(this).find('.img').attr('id') + ".png";
		$('.big-photo-container').addClass('active');
		$('.photo-form img').attr('src', photoSrc);
		if ($('.photo-form').css('width') > '210px') {
			$('.photo-form').animate(
				{opacity: 1,
					width: '700px',
					height: '500px',
		...
		} else if ($('.photo-form').css('width') == '210px') {
			$('.photo-form').animate(
				{opacity: 1,
					width: '420px',
					height: '300px',
		...
		} else if ($('.photo-form').css('width') == '155px') {
			$('.photo-form').animate(
				{opacity: 1,
					width: '310px',
					height: '220px',
	...
	$('.big-photo-container').on('click', '.prev', function () {
		var prevPhotoSrc = '';
		if ($('.photo-form img').attr('src') == "img/photo1.png") {
			prevPhotoSrc = "img/photo4.png";
		} else if ($('.photo-form img').attr('src') == "img/photo2.png") {
			prevPhotoSrc = "img/photo1.png";
		} else if ($('.photo-form img').attr('src') == "img/photo3.png") {
			prevPhotoSrc = "img/photo2.png";
		} else if ($('.photo-form img').attr('src') == "img/photo4.png") {
			prevPhotoSrc = "img/photo3.png";
		}
		$('.photo-form img').attr('src', prevPhotoSrc);
	});
	$('.big-photo-container').on('click', '.next', function () {
		var nextPhotoSrc = '';
		if ($('.photo-form img').attr('src') == "img/photo1.png") {
			nextPhotoSrc = "img/photo2.png";
		} else if ($('.photo-form img').attr('src') == "img/photo2.png") {
			nextPhotoSrc = "img/photo3.png";
		} else if ($('.photo-form img').attr('src') == "img/photo3.png") {
			nextPhotoSrc = "img/photo4.png";
		} else if ($('.photo-form img').attr('src') == "img/photo4.png") {
			nextPhotoSrc = "img/photo1.png";
		}
		$('.photo-form img').attr('src', nextPhotoSrc);
	});
	$('.photo-before').on('click', function () {
		if ($('.photo-form').css('width') == '700px') {
			$('.photo-form').animate(
				{opacity: 0,
					width: '350px',
					height: '250px',
					marginTop: '-125px',
					marginLeft: '-175px'}, 400);
		} else if ($('.photo-form').css('width') == '420px') {
			$('.photo-form').animate(
				{opacity: 0,
					width: '210px',
					height: '150px',
					marginTop: '-75px',
					marginLeft: '-105px'}, 400);
		} else if ($('.photo-form').css('width') == '310px') {
			$('.photo-form').animate(
				{opacity: 0,
					width: '155px',
					height: '110px',
		...
		setTimeout(function() {
			$('.big-photo-container').removeClass('active');
		}, 200);
	});
	$('.close').on('click', function () {
		if ($('.photo-form').css('width') == '700px') {
	...
	//E-mail Ajax Send
	$("form.callback-form, form.callback-header-form, form.services-callback-form").submit(function() { //Change
		var th = $(this);
		$.ajax({
			type: "POST",
			url: "mail.php", //Change
